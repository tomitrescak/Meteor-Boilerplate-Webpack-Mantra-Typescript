...
declare module Meteor {
  ...
  interface EventHandlerFunction extends Function {
    (event?:Meteor.Event, template?:any):void;
  }
...
declare module Accounts {
  ...
  var _resetPasswordToken: string;
  var _verifyEmailToken: string;
...
declare module Mongo {
  ...
  interface Collection<T> {
    ...
    findOne<U>(selector?:any, options?:{
      sort?: Mongo.SortSpecifier;
      skip?: number;
    ...
    update(selector:any, modifier:Mongo.Modifier, options?:{
      multi?: boolean;
      upsert?: Boolean;
      removeEmptyStrings?: Boolean;
    }, callback?:Function): number;
    upsert(selector:any, modifier:Mongo.Modifier, options?:{
      multi?: boolean;
  ...
  interface Cursor<T> {
    ...
    map<U>(callback:<T>(doc:T, index:number, cursor:Mongo.Cursor<T>) => void, thisArg?:any): [U];
...
interface TemplateStatic {
  new(): Template;
  // It should be [templateName: string]: TemplateInstance but this is not possible -- user will need to cast to TemplateInstance
  [templateName: string]: Template | any; // added "any" to make it work
  head: Template;
  body: Template;
  currentData<T>(): T;
  instance<T>(): T;
  parentData<T>(numLevels?:number): T;
